...
<Navbar/>
      ...
      <center>Buy Herbalife Nutrition products from one of our Associates
        <button className='allbutton'>LEARN MORE</button>
        <div className="allbody">
          <div className="col-md-10">
            <h3 className='my-5'>Our Products</h3>
            <h5>
            Herbalife Nutrition has a wide range of products that are manufactured to 
            support your nutrition goals, no matter how complex they seem. Whether it’s 
            maintaining an ideal and healthy weight or striving to improve your strength 
            and performance, we are your one stop shop for support and guidance.
            </h5>
          </div>
        </div>
      </center>
